...
{
    public partial class WorEditProfConfirm : Form
    {
        private readonly string fieldType;
        private readonly string currentValue;

        public WorEditProfConfirm(string fieldType, string currentValue)
        {
            InitializeComponent();
        ...
        {
            WorEditProfile editProfilePage = new WorEditProfile();
